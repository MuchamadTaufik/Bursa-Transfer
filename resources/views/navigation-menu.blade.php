        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::user()->role == 'manager')
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('bursa-transfer.index') }}" :active="request()->routeIs('bursa-transfer.*')">
                            {{ __('Bursa Transfer') }}
                        </x-nav-link>
                    </div>
                @endif
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative flex items-center ms-3">
                    <a href="{{ route('notifikasi.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 cursor-pointer hover:text-gray-700 {{ Route::is('notifikasi.index') ? 'text-gray-700' : 'text-gray-500' }}">
