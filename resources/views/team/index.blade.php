                                ...
                                <table class="min-w-full divide-y divide-gray-300 table-fixed">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Rate Team</th>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        @forelse ($teams as $team)
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-3 py-4 text-sm text-gray-500 whitespace-nowrap">
                                                    Rate {{ round(($team->total_fisik + $team->total_kecepatan + $team->total_penyerangan + $team->total_bertahan + $team->total_teknik) / $team->total_pemain) }} 
                                                </td>
